...
const spkrCards = [{
  id: 0,
  img: '<img src="Assets/speaker_01.png" alt="kilnam chon">',
...
{
  id: 1,
  img: '<img src="Assets/speaker_02.png" alt="kilnam chon">',
  text1: 'SohYeong Noh',
...
{
  id: 2,
  img: '<img src="Assets/speaker_03.png" alt="kilnam chon">',
  text1: 'Lila Tretikov',
...
{
  id: 3,
  img: '<img src="Assets/speaker_04.png" alt="kilnam chon">',
  text1: 'Kilnam Chon',
...
{
  id: 4,
  img: '<img src="Assets/speaker_05.png" alt="kilnam chon">',
  text1: 'Julia Reda',
...
{
  id: 5,
  img: '<img src="Assets/speaker_06.png" alt="kilnam chon">',
  text1: 'Ryan Merkley',
  ...
  spkrCards.filter((card) => card.id < 2).forEach((card) => {
    const cardInfo = `
      <article class="speaker_card">
                      <div class="speaker_card_img">${card.img}</div>
